	...
	static ITransporterContainer changeSPTransClientsAndContainerFromSPTransData(Map<Integer, ITimeableTransportable> idClient_Client,
		...
		while ((line = br.readLine()) != null) {
			...
			try {
				...
				// hor·rio do compromisso do arquivo na ida
				...
				// nao h· hor·rio definido para o compromisso, ent„o pode ser atÈ 30 min antes de ser buscado para ir para casa (viagem de volta)
				else {
